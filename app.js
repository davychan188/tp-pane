/* tp-pane (offline GeoPackage / tree media viewer)
   v109: project backup/restore lives in import-extras. v99: map tap opens catalog / syncs bottom list to selected tree ID. v98: sidebar above map-ref. v97: hide labels while zooming.
...
(function () {
  ...
  (function lockDocumentPinchZoom() {
    const ALLOW = "#map-ref-viewer, #map-ref-zoom-stage, #media-panel, #media-pdf-main, #media-pdf-scroll, #media-pdf-stage, .media-pdf-stage, #media-pdf-canvas, #media-pdf-ink-layer, .media-viewer, .media-frame, #map, .leaflet-container, .map-annotate-layer";
