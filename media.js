/**
 * Media panel: PDF page viewer via pdf.js canvas (v94: restore v90 portrait ≤700; keep Import overlay close; v90: annotate-only auto T# ids (import-extras); v89: always-on tree labels via annotate CSS/JS; v88: 加樹 short-tap place; v88: remove export/download hints; v86: map crop+sheets; v85: page pinch locked; PDF/map-ref only. v84: CSS pinch, crisp on end).
...
(function () {
  ...
  function ensurePdfjsConfigured() {
    ...
    try {
      ...
      lib.GlobalWorkerOptions.workerSrc = workerSrc || "vendor/pdf.worker.min.js?v=94";
