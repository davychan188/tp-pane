/**
 * Media panel: PDF page viewer via pdf.js canvas (v86: map crop+sheets; v85: page pinch locked; PDF/map-ref only. v84: CSS pinch, crisp on end).
...
(function () {
  ...
  function ensurePdfjsConfigured() {
    ...
    try {
      ...
      lib.GlobalWorkerOptions.workerSrc = workerSrc || "vendor/pdf.worker.min.js?v=86";
