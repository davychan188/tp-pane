/**
 * Media panel: PDF page viewer via pdf.js canvas (v114 pen topbar; v113 flush gap; v112 densify; v111 portal topbar menus; v110 topbar menus + PDF blob worker + import UX; v109 cache bump; v104: list PDF moved to import-extras; v103: robust finger pinch after hide-map enlarge; late-start 2-finger; v102: media ink; v101/v100 prior).
...
(function () {
  ...
  function resolvePdfWorkerSrc() {
    ...
    if (base) {
      ...
      src = "vendor/pdf.worker.min.js?v=114";
    }
    try {
